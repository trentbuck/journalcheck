# This sed program is used by journalcheck --summarize. (-*-conf-*-)
# Since these replacements are (relatively) expensive and host-specific,
# they're broken out into a conffile.
